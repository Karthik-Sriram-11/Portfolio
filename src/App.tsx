...
function Nav() {
  ...
  const items = ['Home', 'Journey', 'Craft', 'Stack', 'Connect']
...
function Home() {
  ...
  return <>
    ...
    <main>
      ...
      <section id="experience" className="section experience"><motion.div {...reveal} className="eyebrow accent">IN THE ARENA</motion.div><motion.div {...reveal} className="achievement-bar"><span>HACKWITHAI</span><p>Top 50 of ~1,000 teams at Telangana’s largest 24-hour offline AI hackathon.</p><span>HACK WITH HYDERABAD</span><p>Top 1,000 of 3,000 teams at Microsoft Hyderabad.</p><span>AEON ’25</span></motion.div></section>
